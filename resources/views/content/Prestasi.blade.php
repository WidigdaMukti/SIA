        ...
        <div class="row d-flex justify-content-center">
            <div class="col p-5 pt-0" style="margin: 0 5%;">
                <div class="container-fluid p-0 mb-5" style="overflow: hidden;">
                    <img class="rounded-4" src="{{ asset('storage/' . $prestasi->thumbnail) }}" alt=""
                        style="width: 100%; height: auto; object-fit: cover;">
                </div>
                <h1 class="mb-4 responsive-text-title-2" style="font-weight: bold">{{ $prestasi->nama }}</h1>
                ...
                <p class="card-text text-gray responsive-text-normal"
                    ...
                    {!! convertMarkdownToHtml($prestasi->content) !!}
                </p>
            </div>
        </div>
    </div>
